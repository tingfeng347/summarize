    ...
    ac87: function (e, t, a) {
        ...
        var r = function () {
            ...
            return a("el-card", {staticClass: "grade"}, [a("div", [a("el-form", {
                ...
                slot: "reference"
            }, [e._v("批量删除")])], 1)], 1), a("el-form-item", {attrs: {label: "教室名称:"}}, [a("el-select", {
                attrs: {size: "small"},
                model: {
                ...
                attrs: {
                    title: e.form.id ? "修改班级课程信息" : "添加班级课程信息",
            ...
            name: "ClazzManage", data: function () {
                return {
                    ...
                    rules: {
                        name: [{required: !0, message: "请输入班级名称"}, {
                            min: 3,
                            message: "班级名称不能小于3位"
                        }],
                        number: [{required: !0, message: "请输入班级人数"}, {validator: this.validateNumber}],
                        headmaster: [{required: !0, message: "请输入教师名称"}, {
                            min: 2,
                            message: "教师名称不能小于2位"
                        }],
                        email: [{required: !0, message: "请输入教师邮箱"}, {
                            type: "email",
                            message: "不是合法的邮箱格式"
                        }],
                        telephone: [{required: !0, message: "请输入教师电话"}, {
                            pattern: /^[1]([3-9])[0-9]{9}$/,
                            message: "不是合法的手机号格式"
                        }],
                        gradeName: [{required: !0, message: "请选择教室名称"}],
                        introducation: [{required: !0, message: "请输入课程信息"}, {min: 10, message: "课程信息至少10位"}]
                    }
                }
            }, mounted: function () {
