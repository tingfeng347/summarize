    ...
    "2fa5": function (e, t, a) {
        ...
        var r = function () {
            ...
            return a("el-card", {staticClass: "grade"}, [a("div", [a("el-form", {
                ...
                slot: "reference"
            }, [e._v("批量删除")])], 1)], 1), a("el-form-item", {attrs: {label: "教室名称:"}}, [a("el-input", {
                attrs: {
                    placeholder: "请输入教室名称",
                    size: "small"
                }, model: {
            ...
            name: "GradeManage", data: function () {
                return {
                    ...
                    rules: {
                        name: [{required: !0, message: "请输入教室名称"}, {min: 3, message: "教室名称不能小于3位"}],
                        manager: [{required: !0, message: "请输入主任姓名"}, {min: 2, message: "教室名称不能小于2位"}],
                        email: [{required: !0, message: "请输入预定人邮箱"}, {
                            type: "email",
                            message: "不是合法的邮箱格式"
                        }],
                        telephone: [{required: !0, message: "请输入预定人电话"}, {
                            pattern: /^[1]([3-9])[0-9]{9}$/,
                            message: "不是合法的手机号格式"
                        }],
                        introducation: [{required: !0, message: " "}, {min: 10, message: "预定科目及上课时间至少10位"}]
                    }
                }
            }, mounted: function () {
                this.getList()
